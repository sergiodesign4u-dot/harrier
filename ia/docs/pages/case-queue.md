...
| **The verdict** | The draft verdict, in a phrase, and **whether the action it proposes is above this tenant's latitude** | This is the thing being ruled on. It is why the row exists. The latitude mark is what makes rank 2 of the order legible instead of mysterious, and it is not a state chip |
