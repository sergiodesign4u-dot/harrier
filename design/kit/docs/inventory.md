...
|  |  | `z1` | `components/z1.css` | [`z1.html`](../z1.html) | none, not interactive | **round 3** | **the point**. a zone of the shell, and the shell is the only thing that measures the viewport | **response**, a boundary and ink, on the keyboard trigger at 120ms |
