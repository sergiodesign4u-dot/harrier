...
window.KIT_NAV = {
  groups: [
    ...
    { key:'atoms', label:'Atoms', pages:[
        ...
        { file:'glyph.html', label:'Glyph',
          mini:'<i class="glyph glyph--menu"></i> <i class="glyph glyph--dismiss"></i> <i class="glyph glyph--next"></i>',
          blurb:'140 icons that were typed as characters until 2026-08-26. An icon typed as a character is still an icon, and it is the worst kind.' },
        { file:'select.html', label:'Select',
          mini:'<span class="input" style="width:132px;padding:4px 8px;display:inline-flex;align-items:center;gap:8px"><span style="flex:1 1 0">Keyboard map</span><span class="select__mark"></span></span>',
          blurb:'It left input on 2026-08-26 and took the platform\'s popup with it. Four instances, one screen, and the only component here whose keyboard is a file of its own.' },
    ...
    { key:'molecules', label:'Molecules', pages:[
        ...
        { file:'keyrow.html', label:'Key row',
          mini:'<span class="key">a</span> <span style="font-size:12.5px">Accept</span>',
          blurb:'It stands inside optlist beside opt and it is not one: an opt is a link with four states, and every row of the keyboard map is inert.' },
        ...
        { file:'miss.html', label:'Miss',
          mini:'<span style="font:600 17px/1 var(--font-sans)">Not found</span>',
          blurb:'An address resolved to nothing, and the page may not say which kind of nothing. It names two exits and no cause.' },
