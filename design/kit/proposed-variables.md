...
| **Why it matters now** | two thirds of the content axis in `docs/inventory.md` section 5 is empty. Every icon in the product will be a decision with no wireframe behind it, and that is the class of thing that drifts if it is not settled once in the kit |
