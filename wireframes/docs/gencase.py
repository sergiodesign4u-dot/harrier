...
EVIDENCE = """        <section class="block">
          ...
          <div class="claim claim--absence"><span class="tag">not found</span><span class="txt">no password change, and no new device enrolment</span><a class="src" href="case.html">Entra, EDR</a></div>
          <div class="claim claim--against"><span class="tag">points the other way</span><span class="txt">this user has travelled to this region twice in 90 days</span><a class="src" href="case.html">tenant baseline</a></div>
