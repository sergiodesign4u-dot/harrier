...
- Why the system looks like this, and the four doors into it: `design/kit/why.html`. The rules, the eleven prohibitions and how to add to it: `design/kit/docs/architecture.md`. What it cannot do yet: `design/kit/docs/backlog.md`. What every pass found: `design/kit/docs/critique.md`.
